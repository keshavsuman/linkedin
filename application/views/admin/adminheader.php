...
<head>
  ...
  <title>Admin Panel | AcroLinkedin</title>
 ...
 <div class="navbar-wrapper">
   <div class="navbar-header">
     <ul class="nav navbar-nav">
       <img src="<?php echo base_url('assets/images/logo/aitr_logo_it.png')?>" style="width:100%;">
       ...
       <ul class="nav navbar-nav float-xs-right">
         ...
         <!-- <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
           <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
             ...
             <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                 <div class="media">
                   <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo  base_url('assets/images/portrait/small/avatar-s-1.png')?>" alt="avatar"><i></i></span></div>
                   <div class="media-body">
                 ...
                 <div class="media">
                   <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?php echo  base_url('assets/images/portrait/small/avatar-s-2.png')?>" alt="avatar"><i></i></span></div>
                   <div class="media-body">
                 ...
                 <div class="media">
                   <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo  base_url('assets/images/portrait/small/avatar-s-3.png')?>" alt="avatar"><i></i></span></div>
                   <div class="media-body">
                 ...
                 <div class="media">
                   <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?php echo  base_url('assets/images/portrait/small/avatar-s-6.png')?>" alt="avatar"><i></i></span></div>
                   <div class="media-body">
         ...
         <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img
                 src="<?php echo  base_url('assets/images/portrait/small/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?php echo $this->session->admin_id;?></span></a>
           <div class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a><a href="#" class="dropdown-item"><i class="icon-mail6"></i> My Inbox</a><a href="#" class="dropdown-item"><i
                 class="icon-clipboard2"></i> Task</a><a href="#" class="dropdown-item"><i class="icon-calendar5"></i> Calender</a>
