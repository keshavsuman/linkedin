        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="<?php echo base_url('assets/images/logo/aitr_logo_it.png');?>" alt="logo"></div>
                </div>
                ...
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="<?php echo base_url('admin/login');?>" method="post" novalidate>
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12 text-xs-center text-md-right"><?php echo anchor("home/forget_password","Forget password",array('class'=>'card-link')); ?></div>
                        </fieldset>
