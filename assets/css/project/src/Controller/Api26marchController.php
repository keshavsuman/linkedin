...
class ApiController extends RestController
{
	 ...
	 function homeapi()
	{
		...
		$data['record']=$co;
		$data['category']=$this->getCategorList();;
	...
	function addToCart(){
	 ...
	 function getCart(){
    	...
    	if((int)$customer_id>0){
    		...
    		$cart = $table->find()->select(['quote_id'=>'entity_id','entity_id','items_count','grand_total','customer_id'])->where(['customer_id'=>$customer_id,'entity_id'=>$quote_id])->contain(['QuoteItem'=>function($q){
