<script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>
 ...
 <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Weiver List</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Weiver List</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Weiver List</h4>
  ...
  <a href="http://52.66.195.100/weiver" class="btn btn-primary">Reset</a>
 
 
</form> 
								</div>
								<div class="col-4">
									 <span class="btn btn-primary add_wavies">Add Weiver/Refund</span> 
								<!--
                ...
                <!-- ============================================================== -->
						 ...
						 <div id="responsive-wavies-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
									...
									<form method="post" action='addextra' style="padding:3%;">
									 ...
									 <input type="hidden" id='status_type' name='status_type' value='waiver'>
                                        <div class="modal-content" style="margin:2%;padding:3%;">
										 <div class="form-group" style="margin-left:6%;">
										   <label>Select Waives Type</label> </br>
										   <input style="opacity:1;left:20px;/*! margin-left: 6%; */opac" checked type="radio" value="waives" name="wav_type">Waives  </br>
										   <input  style="opacity:1;left:20px;/*! margin-left: 6%; */"  type="radio" value="bonus" name="wav_type">Bonus 
										 </div>
	...
	<?php } ?>
										 ...
										 <span id="waiver_check">
										  ...
										  <br/>
										 <p id="alread_waiver" style="display:none;"> <b> Already waiver of Rs <span id="waiver_exit_amount"></span> exit</b></p>
										  
										  <input type="text" placeholder="Waives Amount" id="amount" name="amount" class='form-control'/>
										  <br/>
										 
										</div>
										 <div class="form-group" style="margin-left:6%;">
										   <label> Waives For</label> </br>
