 ...
 <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">D+5 order List</h4>
  ...
  <a href="http://52.66.195.100/catelog" class="btn btn-primary">Reset</a>
                                ...
                                <div class="table-responsive m-t-40">
									...
									<td><?php if($p['deliver_date']!="0000-00-00 00:00:00"){echo date('d-m-Y h:i A',strtotime($p['deliver_date']));
										}?></td>
										...
										<?php if(($p['return_time']=="n") && $p['order_status']==6 && $p['payment_status']=="n"){ ?>
										  <span class="make_payment"  data-id='<?php echo $p['item_order_id']; ?>' r_payable_amount='<?php echo round($p['my_earning']*(int)$p['qty']);?>' s_payable_amount='<?php echo round($settlement_amount);?>' order_status="<?php echo $p['order_status'];?>"  data-toggle="tooltip" data-original-title="Proceed Next"> <i class="fa fa-check text-inverse m-r-10"></i> </span>
									...
									<span style="color:black;" class="label label-sm label-<?php echo $label ?>"><?php  $payment_status=$p['payment_status'];
									if($payment_status=="n" && $p['return_time']=='y'){ echo "Not Applicable";} else { if($payment_status=="n"){ echo "Not Requeuested";}}
									if($payment_status=="requested"){ echo "Requeuested";}
									if($payment_status=="made"){ echo "Payment Done";}
									?></span><br/>
									</a></span>
                ...
                <!-- ============================================================== -->
                   <div id="responsive-reject-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						 ...
						 <div id="responsive-status-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
								...
								<form action="makeprepayment" method="post" style="padding:3%;">
