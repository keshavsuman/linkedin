                                ...
                                <div class="table-responsive m-t-40">
								  <?php if(count($product_data)>0){ ?>
									...
									<?php echo $i;?>
										...
										<td class="hidden-480">
										<span style="color:<?php echo $p['color'];?>;background:<?php echo $p['s_color'];?>" class="label label-sm label-<?php echo $label ?>"><?php echo $p['show_status'];?></span>
										<?php  $changearr = array('1','5','7','10','9','8'); if(in_array($p['order_status'],$changearr)==false){if($login_role==1 || $login_role==5 || $login_role==3){ if(($p['manual_ship']=="y") && $p['order_status']>1){ ?>
										  <span class="change_status"  data-id='<?php echo $p['item_order_id']; ?>' order_status="<?php echo $p['order_status'];?>" show_status="<?php echo $p['show_status'];?>" data-toggle="tooltip" data-original-title="Change Status"> <i class="fa fa-check text-inverse m-r-10"></i> </span>
										 
										<?php } }$arr = array('1','4','5','7','11','10');
										     
												if(in_array($p['order_status'],$arr)==false) { ?>
										 <span class="track_order" manual_ship='<?php echo $p['manual_ship']; ?>' data-id='<?php echo $p['item_order_id']; ?>' data-toggle="tooltip" data-original-title="Track Status"><i class="fa fa-map-marker text-inverse m-r-10"></i> </span>
                                       ...
                                       <?php $arr = array('4','11','8','6','10');
												if($login_role!=3){
												if(in_array($p['order_status'],$arr)==false) { ?>
										 <span class="reject_order" data-id='<?php echo $p['item_order_id']; ?>' data-toggle="tooltip" data-original-title="Reject"> <i class="fa fa-close text-danger"></i> </span>
