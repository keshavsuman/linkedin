              ...
              <div class="card">
                ...
                <div class="card-body">
					 ...
					 <label class="col-md-3 form-control-label" for="text-input">Select Seller</label>
					  <div class="col-md-9 autocomplete">
                         ...
                         <select id="seller_name" name="seller_id"  class="select2 seller_name form-control" style="width: 100%">
                                    ...
                                    <option seller_name="<?php echo $user['display_name']; ?>" <?php  if($user['id']==$cdetail['seller_id']){ echo "selected";}?> value="<?php echo $user['id']; ?>"><?php echo $user['display_name']; ?></option>
									<?php } ?>   
                                </select>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="hidden" id="seller_address_id" maxlength="2" name="seller_address_id" value="<?php echo $cdetail['seller_address_id'];?>" class="form-control" placeholder=""> 
                        <input type="text" id="percantage_value" maxlength="2" value="<?php echo $cdetail['percantage_value'];?>" name="percantage_value" class="form-control" placeholder="Percantage Value"> 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
					  <?php 
					  $image = $this->request->getAttribute("webroot") ."image/". $cdetail['pic']; 
					  
					  $img_guarantee = $this->request->getAttribute("webroot") ."image/". $cdetail['img_guarantee']; 
					  ?>
					   <?php if($cdetail['pic']){ ?>
							<img src="<?php echo $image;?>" style="max-width:400px;max-height:150px;" />
					  <?php } ?>
						
						  <input type="file" id="catelog_upload" name="pic">
						  <input type="hidden" value="<?php echo $cdetail['offer_id'];?>" id="offer_id" name="offer_id">
                      ...
                      <div class="col-md-9">
					  <?php if($cdetail['img_guarantee']){ ?>
							<img src="<?php echo $img_guarantee;?>" style="max-width:400px;max-height:150px;" />
					  <?php } ?>
					 ...
					 <div class="form-group">
											...
											<div class="input-group">
												<select   id="img_height"  name="img_height" required class="form-control select">
													...
													<option value="<?php echo $style_id;?>" <?php  if($style_id==$cdetail['img_height']){ echo "selected";}?>><?php echo $style['style_name']; ?></option>
													<?php } ?>
					...
					<div class="form-group">
						<div class="input-group">
												<select   id="offer_list" class="form-control">
													...
													<option value="<?php echo $return['id'];?>" <?php  if($return['id']==$cdetail['offer_id']){ echo "selected";}?>><?php echo $return['title']; ?></option>
													<?php } ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="name_en" maxlength="40"  value="<?php echo $cdetail['name_en'];?>" required name="name_en"  class="form-control" placeholder="Catelog Name">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        ...
                        <textarea id="textarea-input" style="max-height: 100px;"  name="description" rows="9" class="textarea_editor_short form-control" placeholder="Short Description.."><?php echo $cdetail['description'];?></textarea>
                      </div>
                    </div>
					<div class="form-group row">
                      ...
                      <div class="col-md-9">
                        ...
                        <textarea id="sharing_description" style="max-height: 100px;"  name="sharing_description" rows="9" class="form-control" placeholder="Sharing Short Description.."><?php echo $cdetail['share_text'];?></textarea>
                      </div>
                    </div>
					<div>
					<hr/>   
					 ...
					 <div class="form-group">
											...
											<div class="input-group">
												<select   id="style_list"  name="style_id" required class="form-control select">
													...
													<?php foreach($att_style as $style){ $s_style_id=$style['id']; ?>
											             
													<option  <?php  if($s_style_id==$cdetail['style_id']){ echo "selected";}?> value="<?php echo $s_style_id;?>"><?php echo $style['style_name']; ?></option>
													<?php } ?>
					...
					<?php if(!empty($attribute_column)):?>
					   <div class="apand_div">
					    <div class="form-group row">
							<div class="form-group col-md-11 row" id="">
							  <?php  foreach($attribute_column as $ac){  ?>
							   <div class="col-sm-6">
							     <select name="selectstyle[]" class="attr_select form-control" style="width: 100%">
										<?php  foreach($re as $style){ $s_a_id=$style['attribute_code'];  ?>
									 <option <?php  if($s_a_id==$ac['attribute_id']){ echo "selected";}?> value="<?php echo $style_id;?>"><?php echo $style['frontend_label']; ?></option>
										<?php }?>
									</select>
							   </div>
							   <div class="col-sm-6">
							     <input type="text"  name="selectvalue[]" value="<?php  echo $ac['attribute_value'];?>" class="form-control selectvalue" placeholder="Attribute Value">
						...
						<div class="row">
							<div class="form-group col-md-11 row" id="">
								 <div class="form-group col-md-11 row dynamic_div" id="dynamic_div">
								   <div class="col-sm-6">
									 <select name="newselectstyle[]" class="attr_select form-control" style="width: 100%">
								   ...
								   <div class="col-sm-6">
									 <input type="text"  name="newselectvalue[]" class="form-control selectvalue" placeholder="Attribute Value">
					...
					<?php endif;?>
					 ...
					 <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="number" id="primary_price" min='0' required  name="primary_price" value="<?php echo $cdetail['primary_price'];?>" class="form-control" placeholder="Price by Suppiler">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="number" id="price_added" min='0'  name="price_added" value="<?php echo $cdetail['price_added'];?>" class="form-control" placeholder="Price Added">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        Rs <span id="final_price"> <?php echo $cdetail['selling_price'];?></span>
						<input type="hidden" id="selling_price" min='0' value="<?php echo $cdetail['selling_price'];?>" name="selling_price"/>
                      </div>
                    </div>
                     <div class="form-group row">
                      <label class="col-md-3 form-control-label" for="password-input">Shipping Charges</label>
                      <div class="col-md-9">
                        <input type="Number" id="shipping_charges" min='0' value="<?php echo $cdetail['shipping_charges'];?>"   name="shipping_charges" class="form-control" placeholder="Shipping Value">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="password-input" name="youtube_link" value="<?php echo $cdetail['youtube_link'];?>" class="form-control" placeholder="Youtube Video Link">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
						...
						<input style="display:inherit;opacity:100;position: static;" type="checkbox" id="inline-radio1" name="return_applicable"   <?php if($cdetail['return_applicable']){ echo "checked";} ?>> Return Applicable
                       
                        
						</label>
                        <label class="radio-inline" for="inline-radio2">
                          <input style="display:inherit;opacity:100;position: static;" type="checkbox" id="cod_select" name="cod" <?php if($cdetail['cod']){ echo "checked";} ?>> COD
                        </label>
						<label class="radio-inline" for="inline-radio2">
                          <input style="display:inherit;opacity:100;position: static;" type="checkbox" id="inline-radio2" name="top_catelog" <?php if($cdetail['top_catelog']){ echo "checked";} ?>> Top Catelog
                        </label>
					...
					<div class="form-group">
						<div class="input-group">
												<select   id="cod_policy" class="form-control">
													...
													<option <?php  if($return['id']==$cdetail['cod_id']){ echo "selected";}?> value="<?php echo $return['id'];?>"><?php echo $return['policy_name']; ?></option>
													<?php } ?>
					 ...
					 <div class="form-group row">
                      ...
                      <div class="col-md-12">
                       <textarea  style="max-height:50px;" id="cod_rule"  name="cod_rule" rows="9" class="form-control" placeholder="Short Description.."><?php echo $cdetail['cod_rule']; ?></textarea>
                      </div>
                    </div>
					<?php } ?>
					...
					<div class="form-group">
						<div class="input-group">
												<select   id="return_policy" class="form-control">
													...
													<option <?php  if($return['id']==$cdetail['policy_id']){ echo "selected";}?> value="<?php echo $return['id'];?>"><?php echo $return['policy_name']; ?></option>
													<?php } ?>
					 ...
					 <div class="form-group row">
                      ...
                      <div class="col-md-12">
                       <textarea id="return_rule" onChange="ShareMsg()" style="" name="return_rule" rows="9" class="form-control" placeholder="Short Description.."><?php echo $cdetail['return_rule']; ?></textarea>
                      </div>
                    </div>
					<?php } ?>
				...
				<input type="submit" class="btn btn-sm btn-primary catelog_save" value="Edit"/>
            ...
            <div class="col-md-5">
				...
				<div class="form-group"
                                        ...
                                        <div class="input-group">
                                            <select   id="mode_style"  name="mode_id" required class="form-control select required">
													...
													<option  <?php  if($mode_id==$cdetail['mode_id']){ echo "selected";}?> value="<?php echo $mode_id;?>"><?php echo $m['mode_name']; ?></option>
													<?php } ?>
												
											</select>
                                        </div>
                  </div>
				 <div class="card-body mode_detail"  id="mode_detail">
						<div class="form-group">
                                        <label for="exampleInputuname2">Package Length</label>
                                        <div class="input-group">
                                            <input type="text" id="packageLength" value="<?php echo $cdetail['packageLength']?>" name="packageLength" placeholder="Package Length" class="required-entry form-control"/>
						...
						<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="packageWidth" name="packageWidth" value="<?php echo $cdetail['packageWidth']?>" placeholder="Package Width" class="required-entry form-control"/>
                                            <div class="input-group-addon"></div>
                                        </div>
                            </div>
							<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="packageHeight" name="packageHeight" value="<?php echo $cdetail['packageHeight']?>" placeholder="Package Height" class="required-entry form-control"/>
                                            <div class="input-group-addon"></div>
                                        </div>
                            </div>
							<div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="packageWeight" name="packageWeight" value="<?php echo $cdetail['packageWeight']?>" placeholder="Package Weight" class="required-entry form-control"/>
                                            <div class="input-group-addon"></div>
                                        </div>
                            </div>
                </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9"> 
                        <input type="Number" required  maxlength="2" value="<?php echo $cdetail['max_ratio'];?>"  name="max_ratio" class="form-control" placeholder="Max Earning">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <textarea name="share_text" id="share_text" required class=" form-control" rows="15" placeholder="Enter text ..."><?php echo $cdetail['share_text'];?></textarea>
