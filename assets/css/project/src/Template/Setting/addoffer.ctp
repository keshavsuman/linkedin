				   ...
				   <div class="col-lg-6">
					...
					<div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text" id="title" class="form-control required-entry" name="title">
									...
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text"  class="form-control required-entry" name="subtitle">
									...
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text"  required class="form-control required-entry" name="search_keyword_1">
									...
									<div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text"   class="form-control required-entry" name="search_keyword_2">
								...
								<div class="category_image"></div>
									 ...
									 <div class="form-group">
									   ...
									   <div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="Number" id="offer_value" class="form-control required-entry" name="offer_value">
								<div class="category_image"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
										   <select id="is_active" name="stauts" class="form-control required-entry select">
