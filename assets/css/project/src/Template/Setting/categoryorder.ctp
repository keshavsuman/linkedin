                        ...
                        <div class="card">
                            <div class="card-body">
                                 ...
                                 <div class=" m-t-40">
								   ...
								   <h3>Top Category  order list</h3>
								  
								   <?php foreach ($pagelist as $key => $item) {
									   $shift_pos=$item['shift_category'];
									   $arr[$shift_pos]=$item;
									...
									<div class="row">
									  <?php for($p=1;$p<=10;$p++){ 
									    ...
									    $list=$arr[$p];
									     if($list['shift_category']==$p){ 
										    $image= $this->request->getAttribute("webroot") ."category-thumbnail/". $list['thumbnail'];
										 ?>
										 <div class="card col-3">
											...
											<i  class="add_catelog" catelog_count="<?php  echo $list['catelog_count'];?>" cat_id="<?php echo $list['category_id']; ?>" style="text-align:right" id="<?php echo $list['id']; ?>" pos="<?php echo $p; ?>">Edit</i>
										</div>
										 <?php } else {
									  ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add  Category For position <span id='data_pos'></span></h4>
