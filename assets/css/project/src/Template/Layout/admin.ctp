...
<head>
	...
	<link href="<?php echo $this->request->webroot; ?>assets/plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
    <link href="<?php echo $this->request->webroot; ?>assets/plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                         ...
                         <!-- Light Logo text -->    
                         <img src="<?php echo $this->request->getAttribute("webroot"); ?>home/images/logo.png" class="light-logo" alt="homepage" /></span> </a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> <img src="<?php echo $this->request->getAttribute("webroot"); ?>assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?php echo $this->request->getAttribute("webroot"); ?>assets/images/users/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4><?php echo h($Auth->user('name')); ?></h4>
                                                <p class="text-muted">username : <?php echo h($Auth->user('mobile')); ?></p>
                                    ...
                                    <li><a href="<?php echo $this->Url->Build(['controller'=>'Users','action'=>'logout'])?>"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                        <!-- ============================================================== -->
		...
		<div id="responsive-order-model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                      <div class="modal-dialog" style="max-width:1000px !important;">
									 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											
									
									  
                                       <div class="modal-content order_detail_body">
...
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" /> 
    ...
    <script src="<?php echo $this->request->getAttribute("webroot"); ?>js/custom.min.js"></script>
	 ...
	 <script src="<?php echo $this->request->webroot; ?>assets/plugins/datatables/jquery.dataTables.min.js"></script>
    ...
    <!-- end - This is for export functionality only -->
	    <script src="<?php echo $this->request->webroot; ?>js/dataTables.buttons.min.js"></script>
		     <script src="<?php echo $this->request->webroot; ?>assets/plugins/moment/moment.js"></script>
    <script src="<?php echo $this->request->webroot; ?>assets/plugins/timepicker/bootstrap-timepicker.min.js"></script>
    <script src="<?php echo $this->request->webroot; ?>assets/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
