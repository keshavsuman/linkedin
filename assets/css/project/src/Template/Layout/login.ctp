...
<head>
   ...
   <title>
        <?php
            $cakeDescription = 'Reseller Mantra Admin Dashboard';
        ?>
        <?= $cakeDescription ?>:
        <?= $this->fetch('title') ?>
    </title>
...
<body>
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="<?php echo $this->request->getAttribute("webroot"); ?>assets/plugins/styleswitcher/jQuery.style.switcher.js"></script>
</body>
