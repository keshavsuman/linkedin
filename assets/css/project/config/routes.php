...
Router::prefix('Seller/v1', function ($routes) {
    $routes->getExtensions(['json', 'xml']);
...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/help', ['controller' => 'Pages','action'=>'help']);
	 $routes->connect('/notification', ['controller' => 'Pages','action'=>'notification']);
	 $routes->connect('/offer', ['controller' => 'Pages','action'=>'offer']);
